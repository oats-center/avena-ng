...
For startup and single-neighbor topologies, avenad may also install an overlay-prefix route toward the only active peer as a bootstrap optimization. This does not change path selection semantics because no alternate next hop exists in that state.
